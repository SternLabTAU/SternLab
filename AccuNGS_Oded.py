...
def main():
    ...
    sample_file4 = "/Volumes/STERNADILABHOME$/volume3/okushnir/Cirseq/PV/Mahoney/P2/P2.SRR1036477.V3.2.with.mutation.type.freqs"
    sample_file5 = "/Volumes/STERNADILABHOME$/volume3/okushnir/Cirseq/PV/Mahoney/P3/20170907_q23r2_blastn/PV-p3.1036617.with.mutation.type.freqs"
    ...
    pass_sample3 = 1
    rep_sample3 = 2
    label_sample4 = "PV Mahoney p2"
    pass_sample4 = 2
    rep_sample4 = 1
    label_sample5 = "PV Mahoney p3"
    pass_sample5 = 3
    rep_sample5 = 1
    ...
    data_mutations4["passage"] = pass_sample4
    data_mutations4["replica"] = rep_sample4

    print("loading " + sample_file5 + " as sample")
    data_mutations5 = pd.read_table(sample_file5)
    data_mutations5["label"] = label_sample5
    data_mutations5["passage"] = pass_sample5
    data_mutations5["replica"] = rep_sample5

    print("loading " + control_file + " as homogeneous control")
    data_control = pd.read_table(control_file)
    data_control["label"] = label_control
    data_control["passage"] = pass_control
    data_control["replica"] = rep_control

    data = pd.concat([data_control, data_mutations1, data_mutations2, data_mutations3, data_mutations4, data_mutations5])

    filter_by_coverage_mutation(data, "/Volumes/STERNADILABHOME$/volume3/okushnir/Cirseq/PV/Mahoney/P3/20170907_q23r2_blastn/")
