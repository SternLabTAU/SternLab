...
def main():
    ...
    # sample_file1 = "/volumes/STERNADILABHOME$/volume3/okushnir/SRP/%s/q30_consensus_1e-03/%s.with.mutation.type.freqs" % \
    #              (sample, sample)
    # label_sample1 = "RV-p71"

    ### Creating data_mutations.csv ###
