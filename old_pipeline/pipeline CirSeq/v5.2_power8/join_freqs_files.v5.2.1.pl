...
# V3.1.1 March 11 2014:
# compared to V2: Bug corrected in base_call_and_freqs.pl when reads map to several locations
# V3.2 March 12 2014:
# no counting of repeats with a MUTATION (!= reference) at the end of the read (position >200) 
# V3.3
# Low Q masking instead of chopping off end of read
# V4:
# multiple changes, see base_call.V4.pl
# V4.1: allow gap skipping, do not call mutations at ends of reads
# V5.1: added probability values for observed frequencies  
###################################################################################################
...
sub obtain_freqs_and_out {
    ...
    print OUT "#Created with join V5.1 May 15 2015\n";
